...
<!-- END NAV-SIDEBAR -->
    ...
    <v-content>
      ...
      <img alt="Vue logo" src='@/assets/edificio-f.png' class="flex xs10 offset-xs1 offset-md4 md12">        
      <br>
<h3>Edificio F</h3>
<br>
<img alt="Vue logo" src='@/assets/f-sal.jpeg' class="flex xs12">        
<br>
      </v-flex>
 ...
 <p>
Es el area designada de la institucion de aulas de emergencias para todas las carreras que la institucion ofrece.
</p>
