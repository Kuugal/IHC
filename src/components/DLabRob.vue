...
<!-- END NAV-SIDEBAR -->
    ...
    <v-content>
      ...
      <br>
<h3>Laboratorio de robótica</h3>
<br>
<img alt="Vue logo" src='@/assets/robotica.png' class="flex xs12">        
<br>
      </v-flex>
 ...
 <p>
 Es el dedicado a la realización de estudios prácticos y teóricos sobre el desarrollo de aplicaciones en los campos de la robótica y la mecatrónica.
</p>
