...
<br>
      ...
      <v-flex xs12>
        <br>
 <p>
Es el lugar donde se realizan las reuniones de todos los directivos de la institución para platicar el mejoramiento de la educación de los alumnos de las diferentes carreras.
</p>
