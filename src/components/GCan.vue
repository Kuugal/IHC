...
<!-- END NAV-SIDEBAR -->
    ...
    <v-content>
      ...
      <img alt="Vue logo" src='@/assets/edificio-g.png' class="flex xs10 offset-xs1 offset-md4 md12">        
      <br>
<h3>Edificio G</h3>
<br>
...
<br>
 ...
 <p>
Es el area deportiva que la universidad designo para que los alumnos realicen actividades deportivas a gusto y placer.
</p>
