...
<!-- END NAV-SIDEBAR -->
    ...
    <v-content>
      ...
      <img alt="Vue logo" src='@/assets/edificio-e.png' class="flex xs10 offset-xs1 offset-md4 md12">        
      <br>
<h3>Control escolar</h3>
<br>
<h5>Planta baja</h5>
<img alt="Vue logo" src='@/assets/e-cone.jpeg' class="flex xs12">        
<br>
      </v-flex>
 ...
 <p>
 En este departamento te permite la obtención de información referente a la institución educativa, y a la realización de trámites escolares, reinscripciones e inscripciones entre otras.
</p>
...
<p>
  Ing. Jhovany Israel Romero Clemente
</p>
        </v-flex>
        </v-layout>
        <v-layout row>
