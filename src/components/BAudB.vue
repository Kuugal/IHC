...
<!-- END NAV-SIDEBAR -->
    ...
    <v-content>
      ...
      <img alt="Vue logo" src='@/assets/edificio-b.png' class="flex xs10 offset-xs1 offset-md4 md12">        
      <br>
<h3>Auditorio B</h3>
<br>
<h5>Planta baja</h5>
...
<br>
 ...
 <p>
 Es aquí donde se realizan actividades académicas, cómo exposiciones, presentaciones, proyecciones, conferencias relacionadas con todas las carreras de la universidad.
</p>
<strong>Horario de atención</strong>
<p>
   Depende el evento (debe pedirse 3 días antes si se desea utilizarlo)
</p>
