...
<!-- END NAV-SIDEBAR -->
    ...
    <v-content>
      ...
      <br>
<h3>Laboratorio de manufactura</h3>
<br>
<img alt="Vue logo" src='@/assets/manufactura.png' class="flex xs12">        
<br>
      </v-flex>
 ...
 <p>
 Es el encargado de sensibilizar a los participantes de las implicaciones tecnológicas de la ingeniería de los procesos de fabricación convencionales.
</p>
