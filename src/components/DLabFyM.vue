...
<!-- END NAV-SIDEBAR -->
    ...
    <v-content>
      ...
      <img alt="Vue logo" src='@/assets/edificio-d.png' class="flex xs10 offset-xs1 offset-md4 md12">        
      <br>
<h3>Laboratorio de física y metrología</h3>
<br>
<img alt="Vue logo" src='@/assets/fisica y metrologia.png' class="flex xs12">        
<br>
      </v-flex>
 ...
 <p>
 Este laboratorio brinda servicios relacionados a la experiencia de medición y calibración y a su vez elaborando proyectos de implementación de equipamiento para proveer a la sociedad con mediciones de calidad para la salud seguridad y preservación del ambiente.
</p>
