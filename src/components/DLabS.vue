...
<!-- END NAV-SIDEBAR -->
    ...
    <v-content>
      ...
      <br>
<h3>Laboratorio de simulación</h3>
<br>
<img alt="Vue logo" src='@/assets/simulacion.png' class="flex xs12">        
<br>
      </v-flex>
 ...
 <p>
 Es el dedicado al desarrollo de actividades de enseñanza y aprendizaje a través de la simulación a fin de promover potenciales y procesos cognitivos mediante la confrontación de diversos escenarios.
</p>
