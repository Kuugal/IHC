...
<!-- END NAV-SIDEBAR -->
    ...
    <v-content>
      ...
      <img alt="Vue logo" src='@/assets/edificio-c.png' class="flex xs10 offset-xs1 offset-md4 md12">        
      <br>
<h3>Cafetería</h3>
<br>
...
<br>
 ...
 <p>
 Es el establecimiento que se encuentra dentro de la universidad proporcionando a los alumnos una variedad de productos alimenticios al igual que un lugar donde hace sentir comodo a los alumnos .
</p>
