...
<!-- END NAV-SIDEBAR -->
    ...
    <v-content>
      ...
      <br>
<h3>Dirección de biotecnología</h3>
<br>
<h5>Planta alta</h5>
...
<br>
 ...
 <p>
 En esta dirección es donde se hacen todos los trámites respondientes con las carreras de ingeniería en Biotecnología.
</p>
...
<p>
  Mtro. Felipe de Jesús castillo Hernández
</p>
        </v-flex>
        </v-layout>
        <v-layout row>
