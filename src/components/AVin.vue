...
<!-- END NAV-SIDEBAR -->
    ...
    <v-content>
      ...
      <img alt="Vue logo" src='@/assets/edificio-a.png' class="flex xs12 offset-xs3">        
      <br>
<h3>Vinculación y planeación</h3>
<br>
...
<br>
 ...
 <p>
 Es un departamento del edificio A encargados de realizar las trámites del servicio social o se asocian a otras empresas para que los alumnos vean las ofertas de trabajo y hagan servicio social.
</p>
...
<p>
  C. Johana Paulina Torres Guzmán  
</p>
        </v-flex>
        </v-layout>
        <v-layout row>
